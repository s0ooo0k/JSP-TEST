...
<%
    ...
    if (prompt != null && !prompt.trim().isEmpty()) {
        try {
            ...
            prompt += " 마크다운이나 *, 개행문자 없이 300글자 이내로 알려줘. 적절한 이모지를 섞어줘.";
            ...
            answer = mapper.readValue(httpResponse.body(),
                    GeminiResponse.class).candidates().get(0).content().parts().get(0).text();
